...
public class RCBlocks {
    ...
    public static final RegistryObject<Block> BEDROCK_MINER_BLOCK = createBlock("bedrock_miner_block", () -> new BlockBedrockMiner(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    public static final RegistryObject<Block> GREENHOUSE_BLOCK = createBlock("greenhouse_block", () -> new BlockGreenHouse(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    public static final RegistryObject<Block> ELEVATOR_BLOCK = createBlock("elevator_block", () -> new BlockElevator(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
