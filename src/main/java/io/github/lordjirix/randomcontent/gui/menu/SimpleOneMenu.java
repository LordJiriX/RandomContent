...
public class SimpleOneMenu extends AbstractContainerMenu {

  private final ItemStackHandler handler;

  public SimpleOneMenu(int id, Inventory inv, FriendlyByteBuf buf) {
    this(id, inv, new ItemStackHandler(1));
  }

  public SimpleOneMenu(int id, Inventory playerInv, ItemStackHandler handler) {
    super(RCMenus.SIMPLE_ONESLOT_MENU.get(), id);
