...
public class DataGenMain {
    ...
    public static void gatherData(final GatherDataEvent event) {
        ...
        gen.addProvider(event.includeClient(), new RCItemModelGen(output,Randomcontent.MODID, existingFileHelper));
        event.getGenerator().addProvider(event.includeClient(), (DataProvider.Factory<RCLangGen>) outpu -> new RCLangGen(outpu, MOD_ID, "en_us"));
